...
const handleDelete =async()=>{
    try {
        ...
        console.log(error)
        toast.error('Error in deleting a Product');
    }
}
  ...
  return (
    ...
    <div className="container-fluid m-3 p-3">
      ...
      <Select variant={false} placeholder='Select Category' size='large' showSearch className='form-select mb-3'
...
<input type="file" name='photo' accept='image/*' onChange={(e)=>setPhoto(e.target.files[0])} hidden  />
          ...
          <div className="mb-3">
            {
              ...
              (
                <div className="text-center">
                  <img src={`/api/v1/product/product-photo/${id}`} alt="Product Photo"
                  height='200px'
                  className='img img-responsive' />
                </div>
              )
          ...
          <div className="mb-3">
            <textarea type="text" value={description} placeholder='Enter description'
            className='form-control'
          ...
          <div className="mb-3">
            ...
            <div className="mb-3">
              <Select variant={false} placeholder ='Select shipping'
              showSearch
              size='large'
